...
class ResourceCodebaseRequest(BaseModel):
    ...
    summarize: bool = Field(
        default=True,
        description="Whether to generate summaries for files"
    )
...
class StructureInfo(BaseModel):
    ...
    directories: List[str] = Field(
        ..., 
        description="List of directories in the codebase",
    ...
    total_size_mb: float = Field(
        ..., 
        description="Total size of the codebase in megabytes",
        example=2.5
    )
...
class ResourceCodebaseResult(BaseModel):
    ...
    structure: StructureInfo = Field(
        ..., 
        description="Structural information about the codebase"
    )
...
class ResourceDocsRequest(BaseModel):
    ...
    include_structure: bool = Field(
        default=True,
        description="Whether to include directory structure information"
    )
