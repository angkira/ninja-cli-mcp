...
SETTINGS: list[SettingDef] = [
    ...
    SettingDef(
        "NINJA_MODEL_QUICK", "Quick Model", "Fast model for simple tasks", "opencode/glm-4.7-free"
    ),
    SettingDef(
        "NINJA_MODEL_SEQUENTIAL",
        "Sequential Model",
        "Complex multi-step tasks model",
        "zai-coding-plan/glm-4.7",
    ),
    SettingDef(
        "NINJA_MODEL_PARALLEL",
        "Parallel Model",
        "High-concurrency parallel tasks model",
        "opencode/glm-4.7-free",
    ),
    SettingDef(
        "NINJA_SECRETARY_MODEL",
        "Secretary Model",
        "Model for documentation and analysis",
        "opencode/glm-4.7-free",
    ),
    SettingDef(
        "NINJA_RESEARCHER_MODEL", "Researcher Model", "Model for web research", "sonar-reasoning"
    ),
    ...
    SettingDef(
        "NINJA_AGENT_MODEL", "Agent Model", "Model for agent orchestration", "opencode/glm-4.7-free"
    ),
    # ── Operator / provider ──────────────────────────────────────────────
    SettingDef(
        "NINJA_CODE_BIN",
    ...
    SettingDef(
        "NINJA_CODER_OPENCODE_PROVIDER",
        "OpenCode Provider",
        "Provider passed to the opencode strategy",
        "openrouter",
    ),
    SettingDef(
    ...
    SettingDef(
        ...
        "Absolute Timeout (s)",
        "Hard wall-clock deadline; 0 disables it",
        str(DEFAULT_ABSOLUTE_TIMEOUT_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_ABSOLUTE_TIMEOUT_QUICK",
        "Quick Absolute Timeout (s)",
        "Quick-task wall-clock deadline; 0 disables it",
        str(DEFAULT_ABSOLUTE_TIMEOUT_QUICK_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_ABSOLUTE_TIMEOUT_SEQUENTIAL",
        "Sequential Absolute Timeout (s)",
        "Sequential-task wall-clock deadline; 0 disables it",
        str(DEFAULT_ABSOLUTE_TIMEOUT_SEQUENTIAL_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_ABSOLUTE_TIMEOUT_PARALLEL",
        "Parallel Absolute Timeout (s)",
        "Parallel-task wall-clock deadline; 0 disables it",
        str(DEFAULT_ABSOLUTE_TIMEOUT_PARALLEL_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_INACTIVITY_TIMEOUT",
        "Inactivity Timeout (s)",
        "Abort when no output for this long",
        str(DEFAULT_INACTIVITY_TIMEOUT_QUICK_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_INACTIVITY_TIMEOUT_QUICK",
        "Quick Inactivity Timeout (s)",
        "Quick-task inactivity watchdog",
        str(DEFAULT_INACTIVITY_TIMEOUT_QUICK_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_INACTIVITY_TIMEOUT_SEQUENTIAL",
        "Sequential Inactivity Timeout (s)",
        "Sequential-task inactivity watchdog",
        str(DEFAULT_INACTIVITY_TIMEOUT_SEQUENTIAL_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_INACTIVITY_TIMEOUT_PARALLEL",
        "Parallel Inactivity Timeout (s)",
        "Parallel-task inactivity watchdog",
        str(DEFAULT_INACTIVITY_TIMEOUT_PARALLEL_SEC),
        "int",
    ),
    SettingDef(
        "NINJA_INACTIVITY_COUNT_STDERR",
        "Count Stderr Activity",
        "Reset inactivity watchdog on stderr output",
        "0",
        "choice",
        ("0", "1"),
    ),
    SettingDef(
        ...
        "OpenCode Timeout (s)",
        "Base timeout for the opencode strategy",
        "600",
        "int",
    ),
    SettingDef(
        "NINJA_OPENCODE_QUICK_TIMEOUT",
        "Quick Task Timeout (s)",
        "Max timeout for quick tasks",
        "600",
        "int",
    ),
    SettingDef(
        ...
        "Max timeout for sequential tasks",
        "900",
        "int",
    ),
    SettingDef(
        ...
        "Parallel Timeout (s)",
        "Max timeout for parallel tasks",
        "1200",
        "int",
    ),
    SettingDef(
        "NINJA_OPENCODE_SERVE_TIMEOUT",
        "Serve Task Timeout (s)",
        "Per-task timeout in the serve pool",
        "600",
        "int",
    ),
    SettingDef(
        "NINJA_AIDER_TIMEOUT", "Aider Timeout (s)", "Timeout for the Aider strategy", "300", "int"
    ),
    SettingDef(
        "NINJA_CLAUDE_TIMEOUT",
        "Claude Timeout (s)",
        "Timeout for the Claude strategy",
        "600",
        "int",
    ),
    SettingDef(
    ...
    SettingDef(
        "NINJA_OPENCODE_SERVE_PORT_START",
        "Serve Port Start",
        "First port in the serve pool range",
        "20000",
        "int",
    ),
    SettingDef(
        "NINJA_OPENCODE_SERVE_PORT_END",
        "Serve Port End",
        "Last port in the serve pool range",
        "21000",
        "int",
    ),
    # ── Misc ─────────────────────────────────────────────────────────────
    SettingDef(
        "NINJA_DEDUP_TTL",
        "Dedup TTL (s)",
        "Deduplication window for identical requests",
        "300",
        "int",
    ),
    SettingDef(
        "NINJA_OPENROUTER_PROVIDERS",
        "OpenRouter Providers",
        "Comma-separated provider order for fallback",
        "",
    ),
    SettingDef(
        ...
        "duckduckgo",
        "choice",
        ("duckduckgo", "serper", "perplexity"),
    ),
    SettingDef(
        "NINJA_ENABLE_DAEMON",
        "Enable Daemon",
        "Run MCP servers as background daemons",
        "true",
        "choice",
        ("true", "false"),
    ),
    ...
    SettingDef(
        ...
        "Researcher Port",
        "Daemon port for the researcher server",
        "8101",
        "int",
    ),
    SettingDef(
        ...
        "Secretary Port",
        "Daemon port for the secretary server",
        "8102",
        "int",
    ),
    SettingDef(
        "NINJA_AGENT_PORT",
        "Agent Port",
        "Daemon port for the agent orchestrator server",
        "8103",
        "int",
    ),
    SettingDef(
