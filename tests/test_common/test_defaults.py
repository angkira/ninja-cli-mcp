...
class TestDefaults:
    ...
    def test_anthropic_models_first_is_haiku(self):
        ...
        assert first_model_id == "openrouter/anthropic/claude-haiku-4.5"
        assert "Haiku" in first_model_name
    ...
    def test_openrouter_models_first_is_haiku(self):
        ...
        for model_id, model_name, model_desc in OPENROUTER_MODELS:
            if model_id.startswith("openrouter/anthropic/claude"):
    ...
    def test_all_haiku_models_present(self):
        ...
        assert "openrouter/anthropic/claude-haiku-4.5" in anthropic_haiku_ids
        ...
        assert "openrouter/anthropic/claude-haiku-4.5" in openrouter_haiku_ids
    ...
    def test_haiku_model_order_consistency(self):
        """Test that Haiku is consistently first model in Claude model lists."""
        # In CLAUDE_CODE_MODELS
        assert CLAUDE_CODE_MODELS[0][0] == "claude-haiku-4"

        # In ANTHROPIC_MODELS
        assert ANTHROPIC_MODELS[0][0] == "openrouter/anthropic/claude-haiku-4.5"
        ...
        assert OPENROUTER_MODELS[first_claude_idx][0] == "openrouter/anthropic/claude-haiku-4.5"
